# AI Agent Guide — Astra Customizer Reset

## Quick Start for AI Agents

1. **Entry point:** Start at `class-astra-theme-customizer-reset.php` to understand plugin initialization
...
4. **Text domain:** Use `astra-customizer-reset` for all translatable strings
...
1. Wrap strings in `__( 'text', 'astra-customizer-reset' )` or `esc_html__( 'text', 'astra-customizer-reset' )`
...
- [ ] Text domain `astra-customizer-reset` used for all user-facing strings
